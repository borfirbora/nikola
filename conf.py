...
BLOG_AUTHOR = "Bora FIRLANGEÇ"  # (translatable)
BLOG_TITLE = "örnek sitem"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://server.borfirbora.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://server.borfirbora.com/"
BLOG_EMAIL = "bilgi@borfirbora.com"
BLOG_DESCRIPTION = "Bu örnek bir sitedir!"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        (
            ...
            ("https://borfirbora.com/", "Kendi sitem"),
        ), "Daha Fazla"),
        (
            (
            ("hakkimda.html", "Bizden kalanlar"),
        ), "Hakkımızda"),
    ),
}
